...
import { IndustryFAQItem } from '../../types/industry';
...
export default function IndustryFAQ({ faqs, name }: IndustryFAQProps) {
            ...
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight">
                        Questions about <span className="text-blue-600">{name}</span> Software
                    </h2>
                </div>
