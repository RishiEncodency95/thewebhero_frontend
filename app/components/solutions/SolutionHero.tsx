...
import SolutionBreadcrumb from './SolutionBreadcrumb';
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:items-center">
                    <div className="lg:col-span-7">
                        <div className="inline-flex items-center gap-2 rounded-full border border-blue-400/30 bg-blue-500/10 px-3.5 py-1.5 text-xs font-semibold text-blue-300 backdrop-blur-md mb-6">
                            ...
                            <span>{categoryName} Business Solution</span>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            ...
                            >
                                <span>View Features & Architecture</span>
                            </a>
                        </div>
                        ...
                        <div className="relative rounded-2xl border border-slate-800 bg-slate-900/90 p-6 shadow-2xl backdrop-blur-xl">
                            ...
                            <div className="space-y-4">
                                <div className="rounded-xl border border-blue-500/20 bg-blue-500/10 p-4">
                                    <h4 className="text-sm font-bold text-blue-300 mb-1">Business Impact Focus</h4>
                                    <p className="text-xs text-slate-300 leading-relaxed">
                                        Designed specifically to modernize workflows, improve operational capacity, and drive conversion.
                                    </p>
                                </div>

                                <div className="space-y-2.5">
                                    <div className="flex justify-between items-center text-xs text-slate-400">
                                        <span>System Reliability Target</span>
                                    ...
                                    <div className="flex justify-between items-center text-xs text-slate-400 pt-2">
                                        ...
                                        <span className="font-bold text-blue-400">ISO / AES-256</span>
                                    </div>
                                    <div className="h-2 w-full rounded-full bg-slate-800">
