...
export default function SolutionCTA({ title }: SolutionCTAProps) {
    return (
        <section className="relative overflow-hidden bg-gradient-to-r from-blue-800 via-indigo-800 to-purple-900 text-white py-16 lg:py-20">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white max-w-3xl mx-auto leading-tight mb-6">
                    Deploy Modern <span className="underline decoration-yellow-400 underline-offset-8">{title}</span> Solutions
                </h2>

                <p className="text-base sm:text-lg text-blue-100 font-medium max-w-2xl mx-auto mb-10 leading-relaxed">
                    Partner with TheWebHero to design, build, and deploy production-ready digital solutions engineered for your business model.
                </p>
