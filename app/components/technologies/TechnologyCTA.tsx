...
export default function TechnologyCTA({ name }: TechnologyCTAProps) {
    return (
        <section className="relative overflow-hidden bg-gradient-to-r from-blue-900 via-indigo-900 to-slate-950 text-white py-16 lg:py-20">
            <div className="pointer-events-none absolute -left-20 -top-20 h-72 w-72 rounded-full bg-white/10 blur-3xl" />
            <div className="pointer-events-none absolute -right-20 -bottom-20 h-72 w-72 rounded-full bg-cyan-400/20 blur-3xl" />
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
                <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-white backdrop-blur-md mb-6">
                    ...
                    <span>Build With Senior Engineers</span>
                </div>

                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white max-w-3xl mx-auto leading-tight mb-6">
                    Ready to Build Your Solution With <span className="underline decoration-cyan-400 underline-offset-8">{name}</span>?
                </h2>

                <p className="text-base sm:text-lg text-blue-100 font-medium max-w-2xl mx-auto mb-10 leading-relaxed">
                    Partner with our engineering team to design, build, and deploy production-ready web and mobile applications.
                </p>

                <div className="flex flex-wrap justify-center items-center gap-4">
                    <Link
                        href="/get-a-quote"
                        className="inline-flex items-center justify-center gap-2.5 rounded-full bg-white px-8 py-4 text-sm font-extrabold text-blue-950 shadow-xl transition-all hover:bg-blue-50 hover:scale-[1.03]"
                    >
