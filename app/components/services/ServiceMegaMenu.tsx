...
export default function ServiceMegaMenu({ isOpen, onClose }: ServiceMegaMenuProps) {
    ...
    const activeCategory = SERVICE_CATEGORIES[activeCategoryIndex];
        ...
        >
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
                <div className="grid grid-cols-12 gap-8">
                            ...
                            return (
                                <div key={cat.slug} className="group flex items-center">
                                    <Link
                                        ...
                                        onClick={onClose}
                                        className={`flex-1 flex items-center justify-between rounded-xl px-3.5 py-2.5 text-sm font-bold transition-all ${isActive
                    ...
                    {/* Right Column: Active Category Sub-services */}
                    <div className="col-span-8 flex flex-col justify-between pl-2">
                        ...
                        <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between bg-slate-50 rounded-xl px-5 py-3">
                            <div className="flex items-center gap-2 text-xs text-slate-600 font-semibold">
                                ...
                                <span>Looking for full suite engineering & IT services?</span>
                            </div>
