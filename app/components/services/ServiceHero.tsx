                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:items-center">
                    ...
                    <div className="lg:col-span-7">
                        <div className="inline-flex items-center gap-2 rounded-full border border-blue-400/30 bg-blue-500/10 px-3.5 py-1.5 text-xs font-semibold text-blue-300 backdrop-blur-md mb-6">
                            ...
                            <span>{categoryName} Expertise</span>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            <Link
                                href="/get-a-quote"
                                className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 px-7 py-3.5 text-sm font-bold text-white shadow-lg shadow-blue-500/25 transition-all hover:shadow-blue-500/40 hover:scale-[1.02]"
                            >
                        ...
                        <div className="relative rounded-2xl border border-slate-800 bg-slate-900/90 p-6 shadow-2xl backdrop-blur-xl">
                            ...
                            <div className="space-y-4">
                                <div className="rounded-xl border border-blue-500/20 bg-blue-500/10 p-4">
                                    <h4 className="text-sm font-bold text-blue-300 mb-1">Tailored Service Execution</h4>
                                    <p className="text-xs text-slate-300 leading-relaxed">
                                        Custom engineered to match your specifications, security policies, and performance goals.
                                    </p>
                                </div>
                                ...
                                <div className="space-y-2.5">
                                    ...
                                    <div className="flex justify-between items-center text-xs text-slate-400 pt-2">
                                        ...
                                        <span className="font-bold text-blue-400">ISO & OWASP Verified</span>
                                    </div>
                                    <div className="h-2 w-full rounded-full bg-slate-800">
                                ...
                                <div className="pt-4 mt-4 border-t border-slate-800 flex items-center justify-between text-xs text-slate-400">
                                    ...
                                    <span className="font-bold text-purple-300">Included SLA Retainer</span>
                                </div>
                            </div>
                        </div>
                    </div>
